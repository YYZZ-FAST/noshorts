...
1. Download this repository to your computer (use the green **Code → Download ZIP** button or `git clone`).
...
- Works only in Chrome and other browsers based on Chromium (Edge, Brave, etc.).
- There’s nothing to click or configure; the extension runs automatically.
- To stop using it, disable or remove it from the extensions page.
